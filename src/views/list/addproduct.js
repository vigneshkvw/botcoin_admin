                        ...
                        <div className="row">
									<div className="col-sm-12 col-xs-12">
										...
										<div className="form-wrap">
												<form method="post" action="/add_product" method="post" encType="multipart/form-data">
												<div className="form-group">
													<label className="control-label mb-10" for="exampleInputEmail_2">Product Name</label>
														<input type="text" className="form-control" required="" id="exampleInputEmail_2" onChange={this.handleemailChange} name="name" placeholder="Enter Product Name"/>
												</div>
												<div className="form-group">
